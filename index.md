...
<div class="hero-actions text-center mb-8" markdown="0">
  ...
  <a href="https://github.com/The-Cloud-Clockwork/agenticore" class="btn fs-5" target="_blank">View on GitHub</a>
</div>
...
[![Docker](https://img.shields.io/docker/v/the-cloud-clockwork/agenticore?label=Docker%20Hub)](https://hub.docker.com/r/the-cloud-clockwork/agenticore)
...
[View on GitHub](https://github.com/The-Cloud-Clockwork/agenticore){: .btn .fs-5 }
{: .text-center }
